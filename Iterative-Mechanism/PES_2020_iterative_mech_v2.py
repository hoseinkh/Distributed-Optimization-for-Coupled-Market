"""
This code seems to work relatively okey, however, the absolute rates do not converge!
...
if True:
    ...
    range_all_num.extend(list(range(10,100000,100)))
    #
    list_rho_k = []
    for i in range_all_num:
        ...
        if i < 2:
            ...
            list_rho_k.append(1 / (1 + math.log10(i)))
    #

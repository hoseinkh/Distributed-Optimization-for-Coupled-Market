...
if True:
    ...
    #
    #
    range_all_num.extend(list(range(1, 100)))
    range_all_num.extend(list(range(100,1000,10)))
    range_all_num.extend(list(range(1000,900000000,100000)))
    range_all_num.extend(list(range(900000000, 90000000000, 30000000)))
    #
    #
    list_rho_k = []
    for i in range_all_num:
        ...
        #
        if  i < 10000000:
            list_rho_k.append(1 / (1 + 0.03*math.sqrt(i)))
        elif 10000000 <= i < 900000000:
            list_rho_k.append(1 / (1 + 4.5 * math.log2(i)))
        elif 900000000 <= i:
            list_rho_k.append(1 / (1 + 0.0045 * math.sqrt(i)))
            pass
    #
    # if True:
    #     fig22, ax22 = matplotlib.pyplot.subplots()
    #     # x_data = list_rho_k
    #     x_data = list(range(0, len(list_rho_k)))
    #     y_data = list_rho_k
    #     ax22.plot(x_data, y_data)
    #     ax22.set(xlabel="k", ylabel='r_k', title="r_k")
    #     ax22.set_ylim([min([min(y_data) * 0.5, min(y_data) * 1.5]), max([max(y_data) * 0.5, max(y_data) * 1.5])])
    #     ax22.grid()
...
for current_rho_k in list_rho_k:
    ## Initialization
    if counter == 0:
        # updated_theta_1_tieline_r1_to_r2 = -0.08
        # updated_theta_1_tieline_r1_to_r3 = -0.20
        # updated_theta_2_tieline_r2_to_r1 = -0.07
        # updated_theta_2_tieline_r2_to_r3 = -0.18
        # updated_theta_3_tieline_r3_to_r1 = -0.20
        # updated_theta_3_tieline_r3_to_r2 = -0.20
        ...
        # #
        # updated_tie_line_r1_r2_decent = -15
        # updated_tie_line_r1_r3_decent = -30
        # updated_tie_line_r2_r1_decent = -15
        # updated_tie_line_r2_r3_decent = 18
        # updated_tie_line_r3_r1_decent = 30
        # updated_tie_line_r3_r2_decent = -18
        updated_theta_1_tieline_r1_to_r2 = -0.07
        updated_theta_1_tieline_r1_to_r3 = -0.15
        updated_theta_2_tieline_r2_to_r1 = -0.1
        updated_theta_2_tieline_r2_to_r3 = -0.25
        updated_theta_3_tieline_r3_to_r1 = -0.3
        updated_theta_3_tieline_r3_to_r2 = -0.30
        dict_theta_tielines["theta_1_tieline_r1_to_r2"] = updated_theta_1_tieline_r1_to_r2
        dict_theta_tielines["theta_1_tieline_r1_to_r3"] = updated_theta_1_tieline_r1_to_r3
        dict_theta_tielines["theta_2_tieline_r2_to_r1"] = updated_theta_2_tieline_r2_to_r1
        dict_theta_tielines["theta_2_tieline_r2_to_r3"] = updated_theta_2_tieline_r2_to_r3
        ...
        dict_theta_tielines["theta_3_tieline_r3_to_r2"] = updated_theta_3_tieline_r3_to_r2
        #
        updated_delta_rate_signed_r1_sell_to_r2_decent_r1 = 20
        updated_delta_rate_signed_r1_sell_to_r3_decent_r1 = 20
        updated_delta_rate_signed_r2_sell_to_r1_decent_r2 = 20
        updated_delta_rate_signed_r2_sell_to_r3_decent_r2 = 20
        updated_delta_rate_signed_r3_sell_to_r1_decent_r3 = 20
        updated_delta_rate_signed_r3_sell_to_r2_decent_r3 = 20
        dic_of_delta_signed_rates['delta_rate_signed_r1_sell_to_r2'] = updated_delta_rate_signed_r1_sell_to_r2_decent_r1
        dic_of_delta_signed_rates['delta_rate_signed_r1_sell_to_r3'] = updated_delta_rate_signed_r1_sell_to_r3_decent_r1
        dic_of_delta_signed_rates['delta_rate_signed_r2_sell_to_r1'] = updated_delta_rate_signed_r2_sell_to_r1_decent_r2
        dic_of_delta_signed_rates['delta_rate_signed_r2_sell_to_r3'] = updated_delta_rate_signed_r2_sell_to_r3_decent_r2
        ...
        dic_of_delta_signed_rates['delta_rate_signed_r3_sell_to_r2'] = updated_delta_rate_signed_r3_sell_to_r2_decent_r3
        #
        updated_mu_rate_absol_r1_sell_to_r2_decent_r1 = 10
        updated_mu_rate_absol_r1_sell_to_r3_decent_r1 = 7
        updated_mu_rate_absol_r2_sell_to_r1_decent_r2 = 10
        updated_mu_rate_absol_r2_sell_to_r3_decent_r2 = 2
        updated_mu_rate_absol_r3_sell_to_r1_decent_r3 = 7
        updated_mu_rate_absol_r3_sell_to_r2_decent_r3 = 2
        dic_mu_rate_absol_at_optimum['mu_rate_absol_r1_sell_to_r2'] = updated_mu_rate_absol_r1_sell_to_r2_decent_r1
        dic_mu_rate_absol_at_optimum['mu_rate_absol_r1_sell_to_r3'] = updated_mu_rate_absol_r1_sell_to_r3_decent_r1
        dic_mu_rate_absol_at_optimum['mu_rate_absol_r2_sell_to_r1'] = updated_mu_rate_absol_r2_sell_to_r1_decent_r2
        dic_mu_rate_absol_at_optimum['mu_rate_absol_r2_sell_to_r3'] = updated_mu_rate_absol_r2_sell_to_r3_decent_r2
        ...
        dic_mu_rate_absol_at_optimum['mu_rate_absol_r3_sell_to_r2'] = updated_mu_rate_absol_r3_sell_to_r2_decent_r3
        #
        updated_tie_line_r1_r2_decent = -10
        updated_tie_line_r1_r3_decent = -20
        updated_tie_line_r2_r1_decent = -10
        updated_tie_line_r2_r3_decent = 15
        updated_tie_line_r3_r1_decent = 20
        updated_tie_line_r3_r2_decent = -15
        #
    ...
    counter += 1
    #
    printString = "current percentage of simulations = %{} \n".format(counter * 100 / num_simul); print(printString*100)
    #
    ...
    if True:
        ...
        updated_tie_line_r1_r2_decent = (1 - current_rho_k) * updated_tie_line_r1_r2_decent + current_rho_k * (calculated_tie_line_r1_r2_decent - calculated_tie_line_r2_r1_decent)/2
        updated_tie_line_r2_r1_decent = (1 - current_rho_k) * updated_tie_line_r2_r1_decent + current_rho_k * (calculated_tie_line_r2_r1_decent - calculated_tie_line_r1_r2_decent)/2
        updated_tie_line_r2_r3_decent = (1 - current_rho_k) * updated_tie_line_r2_r3_decent + current_rho_k * (calculated_tie_line_r2_r3_decent - calculated_tie_line_r3_r2_decent)/2
        updated_tie_line_r3_r2_decent = (1 - current_rho_k) * updated_tie_line_r3_r2_decent + current_rho_k * (calculated_tie_line_r3_r2_decent - calculated_tie_line_r2_r3_decent)/2
        updated_tie_line_r1_r3_decent = (1 - current_rho_k) * updated_tie_line_r1_r3_decent + current_rho_k * (calculated_tie_line_r1_r3_decent - calculated_tie_line_r3_r1_decent)/2
        updated_tie_line_r3_r1_decent = (1 - current_rho_k) * updated_tie_line_r3_r1_decent + current_rho_k * (calculated_tie_line_r3_r1_decent - calculated_tie_line_r1_r3_decent)/2
    #
    # update theta-s
    if True:
...
if True:
    ...
    # x_data = list_rho_k
    x_data = list(range(1, num_simul + 1))
    y_data = [z * 180/math.pi for z in list_theta_1_tieline_r1_to_r2]
    ax16.plot(x_data, y_data)
    ax16.set(xlabel="k", ylabel='theta 1: tieline 1 to 2 in degree', title="theta 1: tieline 1 to 2 in degree")
    ...
    # x_data = list_rho_k
    x_data = list(range(1, num_simul + 1))
    y_data = [z * 180/math.pi for z in list_theta_2_tieline_r2_to_r1]
    ax17.plot(x_data, y_data)
    ax17.set(xlabel="k", ylabel='theta 2: tieline 2 to 1 in degree', title="theta 2: tieline 2 to 1 in degree")
    ...
    # x_data = list_rho_k
    x_data = list(range(1, num_simul + 1))
    y_data = [z * 180/math.pi for z in list_theta_1_tieline_r1_to_r3]
    ax18.plot(x_data, y_data)
    ax18.set(xlabel="k", ylabel='theta 1: tieline 1 to 3 in degree', title="theta 1: tieline 1 to 3 in degree")
    ...
    # x_data = list_rho_k
    x_data = list(range(1, num_simul + 1))
    y_data = [z * 180/math.pi for z in list_theta_3_tieline_r3_to_r1]
    ax19.plot(x_data, y_data)
    ax19.set(xlabel="k", ylabel='theta 3: tieline 3 to 1 in degree', title="theta 3: tieline 3 to 1 in degree")
    ...
    # x_data = list_rho_k
    x_data = list(range(1, num_simul + 1))
    y_data = [z * 180/math.pi for z in list_theta_2_tieline_r2_to_r3]
    ax20.plot(x_data, y_data)
    ax20.set(xlabel="k", ylabel='theta 2: tieline 2 to 3 in degree', title="theta 2: tieline 2 to 3 in degree")
    ...
    # x_data = list_rho_k
    x_data = list(range(1, num_simul + 1))
    y_data = [z * 180/math.pi for z in list_theta_3_tieline_r3_to_r2]
    ax21.plot(x_data, y_data)
    ax21.set(xlabel="k", ylabel='theta 3: tieline 3 to 2 in degree', title="theta 3: tieline 3 to 2 in degree")
...
######################################################
# #
# printings and saving results!
if True:
    dsnapshopResults = open("dsnapshopResults.txt", "a")
    detaileResults = open("detaileResults.txt", "a")
    print("optimal value of theta_1_tieline_r1_to_r2 in degree = {}".format(dict_theta_tielines_central['theta_1_tieline_r1_to_r2']*180/math.pi))
    print("optimal value of theta_1_tieline_r1_to_r3 in degree = {}".format(dict_theta_tielines_central['theta_1_tieline_r1_to_r3'] * 180 / math.pi))
    print("optimal value of theta_2_tieline_r2_to_r1 in degree = {}".format(dict_theta_tielines_central['theta_2_tieline_r2_to_r1'] * 180 / math.pi))
    print("optimal value of theta_2_tieline_r2_to_r3 in degree = {}".format(dict_theta_tielines_central['theta_2_tieline_r2_to_r3'] * 180 / math.pi))
    print("optimal value of theta_3_tieline_r3_to_r1 in degree = {}".format(dict_theta_tielines_central['theta_3_tieline_r3_to_r1'] * 180 / math.pi))
    print("optimal value of theta_3_tieline_r3_to_r2 in degree = {}".format(dict_theta_tielines_central['theta_3_tieline_r3_to_r2'] * 180 / math.pi))
    # print("optimal value of theta for tielines = {}".format(dict_theta_tielines_central))
    print("optimal value of theta for tielines = {}".format(dict_theta_tielines_central), file = detaileResults)
    print("optimal value of theta for tielines = {}".format(dict_theta_tielines_central), file = dsnapshopResults)
    # print("optimal value of delta signed rates = {}".format(dic_of_delta_signed_rates_centralized))
    print("optimal value of delta rate_signed_r1_sell_to_r2 = {}".format(dic_of_delta_signed_rates_centralized['rate_signed_r1_sell_to_r2']))
    print("optimal value of delta rate_signed_r1_sell_to_r3 = {}".format(dic_of_delta_signed_rates_centralized['rate_signed_r1_sell_to_r3']))
    print("optimal value of delta rate_signed_r2_sell_to_r1 = {}".format(dic_of_delta_signed_rates_centralized['rate_signed_r2_sell_to_r1']))
    print("optimal value of delta rate_signed_r2_sell_to_r3 = {}".format(dic_of_delta_signed_rates_centralized['rate_signed_r2_sell_to_r3']))
    print("optimal value of delta rate_signed_r3_sell_to_r1 = {}".format(dic_of_delta_signed_rates_centralized['rate_signed_r3_sell_to_r1']))
    print("optimal value of delta rate_signed_r3_sell_to_r2 = {}".format(dic_of_delta_signed_rates_centralized['rate_signed_r3_sell_to_r2']))
    print("optimal value of delta signed rates = {}".format(dic_of_delta_signed_rates_centralized), file = detaileResults)
    print("optimal value of delta signed rates = {}".format(dic_of_delta_signed_rates_centralized), file = dsnapshopResults)
    # print("optimal value of absol rates = {}".format(dic_mu_rate_absol_at_optimum_centralized))
    print("optimal value of mu rate_absol_r1_sell_to_r2 = {}".format(dic_mu_rate_absol_at_optimum_centralized['rate_absol_r1_sell_to_r2']))
    print("optimal value of mu rate_absol_r1_sell_to_r3 = {}".format(dic_mu_rate_absol_at_optimum_centralized['rate_absol_r1_sell_to_r3']))
    print("optimal value of mu rate_absol_r2_sell_to_r3 = {}".format(dic_mu_rate_absol_at_optimum_centralized['rate_absol_r2_sell_to_r3']))
    print("optimal value of mu absol rates = {}".format(dic_mu_rate_absol_at_optimum_centralized), file = detaileResults)
    print("optimal value of mu absol rates = {}".format(dic_mu_rate_absol_at_optimum_centralized), file = dsnapshopResults)
    # print("optimal value of tieline flows = {}".format(dic_Tie_line_centralized))
    print("optimal value of Tie_line_r1_r2_centralized = {}".format(dic_Tie_line_centralized['Tie_line_r1_r2_centralized']))
    print("optimal value of Tie_line_r1_r3_centralized = {}".format(dic_Tie_line_centralized['Tie_line_r1_r3_centralized']))
    print("optimal value of Tie_line_r2_r1_centralized = {}".format(-1*dic_Tie_line_centralized['Tie_line_r1_r2_centralized']))
    print("optimal value of Tie_line_r2_r3_centralized = {}".format(dic_Tie_line_centralized['Tie_line_r2_r3_centralized']))
    print("optimal value of Tie_line_r3_r1_centralized = {}".format(-1*dic_Tie_line_centralized['Tie_line_r1_r3_centralized']))
    print("optimal value of Tie_line_r3_r2_centralized = {}".format(-1*dic_Tie_line_centralized['Tie_line_r2_r3_centralized']))
    print("optimal value of tieline flows = {}".format(dic_Tie_line_centralized), file = detaileResults)
    print("optimal value of tieline flows = {}".format(dic_Tie_line_centralized), file = dsnapshopResults)
    # #
    print("list_rho_k[-10:] = {}".format(list_rho_k[-10:]))
    print("list_rho_k = {}".format(list_rho_k), file = detaileResults)
    print("list_rho_k[-10:] = {}".format(list_rho_k[-10:]), file = dsnapshopResults)
    # #
    print("list_theta_1_tieline_r1_to_r2[-10:] in degree = {}".format([z * 180/math.pi for z in list_theta_1_tieline_r1_to_r2[-10:]]))
    print("list_theta_1_tieline_r1_to_r2 in degree= {}".format([z * 180/math.pi for z in list_theta_1_tieline_r1_to_r2]), file = detaileResults)
    print("list_theta_1_tieline_r1_to_r2[-10:] in degree= {}".format([z * 180/math.pi for z in list_theta_1_tieline_r1_to_r2[-10:]]), file = dsnapshopResults)
    print("list_theta_1_tieline_r1_to_r3[-10:] in degree = {}".format([z * 180/math.pi for z in list_theta_1_tieline_r1_to_r3[-10:]]))
    print("list_theta_1_tieline_r1_to_r3 in degree = {}".format([z * 180/math.pi for z in list_theta_1_tieline_r1_to_r3]), file = detaileResults)
    print("list_theta_1_tieline_r1_to_r3[-10:] in degree = {}".format([z * 180/math.pi for z in list_theta_1_tieline_r1_to_r3[-10:]]), file = dsnapshopResults)
    print("list_theta_2_tieline_r2_to_r1[-10:] in degree = {}".format([z * 180/math.pi for z in list_theta_2_tieline_r2_to_r1[-10:]]))
    print("list_theta_2_tieline_r2_to_r1 in degree = {}".format([z * 180/math.pi for z in list_theta_2_tieline_r2_to_r1]), file = detaileResults)
    print("list_theta_2_tieline_r2_to_r1[-10:] in degree = {}".format([z * 180/math.pi for z in list_theta_2_tieline_r2_to_r1[-10:]]), file = dsnapshopResults)
    print("list_theta_2_tieline_r2_to_r3[-10:] in degree = {}".format([z * 180/math.pi for z in list_theta_2_tieline_r2_to_r3[-10:]]))
    print("list_theta_2_tieline_r2_to_r3 in degree = {}".format([z * 180/math.pi for z in list_theta_2_tieline_r2_to_r3]), file = detaileResults)
    print("list_theta_2_tieline_r2_to_r3[-10:] in degree = {}".format([z * 180/math.pi for z in list_theta_2_tieline_r2_to_r3[-10:]]), file = dsnapshopResults)
    print("list_theta_3_tieline_r3_to_r1[-10:] in degree = {}".format([z * 180/math.pi for z in list_theta_3_tieline_r3_to_r1[-10:]]))
    print("list_theta_3_tieline_r3_to_r1 in degree = {}".format([z * 180/math.pi for z in list_theta_3_tieline_r3_to_r1]), file = detaileResults)
    print("list_theta_3_tieline_r3_to_r1[-10:] in degree = {}".format([z * 180/math.pi for z in list_theta_3_tieline_r3_to_r1[-10:]]), file = dsnapshopResults)
    print("list_theta_3_tieline_r3_to_r2[-10:] in degree = {}".format([z * 180/math.pi for z in list_theta_3_tieline_r3_to_r2[-10:]]))
    print("list_theta_3_tieline_r3_to_r2 in degree = {}".format([z * 180/math.pi for z in list_theta_3_tieline_r3_to_r2]), file = detaileResults)
    print("list_theta_3_tieline_r3_to_r2[-10:] in degree = {}".format([z * 180/math.pi for z in list_theta_3_tieline_r3_to_r2[-10:]]), file = dsnapshopResults)
    print("list_delta_rate_signed_r1_sell_to_r2_decent_r1[-10:] = {}".format(list_delta_rate_signed_r1_sell_to_r2_decent_r1[-10:]))
    print("list_delta_rate_signed_r1_sell_to_r2_decent_r1 = {}".format(list_delta_rate_signed_r1_sell_to_r2_decent_r1), file = detaileResults)
    print("list_delta_rate_signed_r1_sell_to_r2_decent_r1[-10:] = {}".format(list_delta_rate_signed_r1_sell_to_r2_decent_r1[-10:]), file = dsnapshopResults)
    print("list_delta_rate_signed_r2_sell_to_r1_decent_r2[-10:] = {}".format(list_delta_rate_signed_r2_sell_to_r1_decent_r2[-10:]))
    print("list_delta_rate_signed_r2_sell_to_r1_decent_r2 = {}".format(list_delta_rate_signed_r2_sell_to_r1_decent_r2), file = detaileResults)
    print("list_delta_rate_signed_r2_sell_to_r1_decent_r2[-10:] = {}".format(list_delta_rate_signed_r2_sell_to_r1_decent_r2[-10:]), file = dsnapshopResults)
    print("list_delta_rate_signed_r1_sell_to_r3_decent_r1[-10:] = {}".format(list_delta_rate_signed_r1_sell_to_r3_decent_r1[-10:]))
    print("list_delta_rate_signed_r1_sell_to_r3_decent_r1 = {}".format(list_delta_rate_signed_r1_sell_to_r3_decent_r1), file = detaileResults)
    print("list_delta_rate_signed_r1_sell_to_r3_decent_r1[-10:] = {}".format(list_delta_rate_signed_r1_sell_to_r3_decent_r1[-10:]), file = dsnapshopResults)
    print("list_delta_rate_signed_r3_sell_to_r1_decent_r3[-10:] = {}".format(list_delta_rate_signed_r3_sell_to_r1_decent_r3[-10:]))
    print("list_delta_rate_signed_r3_sell_to_r1_decent_r3 = {}".format(list_delta_rate_signed_r3_sell_to_r1_decent_r3), file = detaileResults)
    print("list_delta_rate_signed_r3_sell_to_r1_decent_r3[-10:] = {}".format(list_delta_rate_signed_r3_sell_to_r1_decent_r3[-10:]), file = dsnapshopResults)
    print("list_delta_rate_signed_r2_sell_to_r3_decent_r2[-10:] = {}".format(list_delta_rate_signed_r2_sell_to_r3_decent_r2[-10:]))
    print("list_delta_rate_signed_r2_sell_to_r3_decent_r2 = {}".format(list_delta_rate_signed_r2_sell_to_r3_decent_r2), file = detaileResults)
    print("list_delta_rate_signed_r2_sell_to_r3_decent_r2[-10:] = {}".format(list_delta_rate_signed_r2_sell_to_r3_decent_r2[-10:]), file = dsnapshopResults)
    print("list_delta_rate_signed_r3_sell_to_r2_decent_r3[-10:] = {}".format(list_delta_rate_signed_r3_sell_to_r2_decent_r3[-10:]))
    print("list_delta_rate_signed_r3_sell_to_r2_decent_r3 = {}".format(list_delta_rate_signed_r3_sell_to_r2_decent_r3), file = detaileResults)
    print("list_delta_rate_signed_r3_sell_to_r2_decent_r3[-10:] = {}".format(list_delta_rate_signed_r3_sell_to_r2_decent_r3[-10:]), file = dsnapshopResults)
    print("list_mu_rate_absol_r1_sell_to_r2_decent_r1[-10:] = {}".format(list_mu_rate_absol_r1_sell_to_r2_decent_r1[-10:]))
    print("list_mu_rate_absol_r1_sell_to_r2_decent_r1 = {}".format(list_mu_rate_absol_r1_sell_to_r2_decent_r1), file = detaileResults)
    print("list_mu_rate_absol_r1_sell_to_r2_decent_r1[-10:] = {}".format(list_mu_rate_absol_r1_sell_to_r2_decent_r1[-10:]), file = dsnapshopResults)
    print("list_mu_rate_absol_r1_sell_to_r3_decent_r1[-10:] = {}".format(list_mu_rate_absol_r1_sell_to_r3_decent_r1[-10:]))
    print("list_mu_rate_absol_r1_sell_to_r3_decent_r1 = {}".format(list_mu_rate_absol_r1_sell_to_r3_decent_r1), file = detaileResults)
    print("list_mu_rate_absol_r1_sell_to_r3_decent_r1[-10:] = {}".format(list_mu_rate_absol_r1_sell_to_r3_decent_r1[-10:]), file = dsnapshopResults)
    print("list_mu_rate_absol_r2_sell_to_r3_decent_r2[-10:] = {}".format(list_mu_rate_absol_r2_sell_to_r3_decent_r2[-10:]))
    print("list_mu_rate_absol_r2_sell_to_r3_decent_r2 = {}".format(list_mu_rate_absol_r2_sell_to_r3_decent_r2), file = detaileResults)
    print("list_mu_rate_absol_r2_sell_to_r3_decent_r2[-10:] = {}".format(list_mu_rate_absol_r2_sell_to_r3_decent_r2[-10:]), file = dsnapshopResults)
    print("list_T_r1_to_r2_updated[-10:] = {}".format(list_T_r1_to_r2_updated[-10:]))
    print("list_T_r1_to_r2_updated = {}".format(list_T_r1_to_r2_updated), file = detaileResults)
    print("list_T_r1_to_r2_updated[-10:] = {}".format(list_T_r1_to_r2_updated[-10:]), file = dsnapshopResults)
    print("list_T_r2_to_r1_updated[-10:] = {}".format(list_T_r2_to_r1_updated[-10:]))
    print("list_T_r2_to_r1_updated = {}".format(list_T_r2_to_r1_updated), file = detaileResults)
    print("list_T_r2_to_r1_updated[-10:] = {}".format(list_T_r2_to_r1_updated[-10:]), file = dsnapshopResults)
    print("list_T_r1_to_r3_updated[-10:] = {}".format(list_T_r1_to_r3_updated[-10:]))
    print("list_T_r1_to_r3_updated = {}".format(list_T_r1_to_r3_updated), file = detaileResults)
    print("list_T_r1_to_r3_updated[-10:] = {}".format(list_T_r1_to_r3_updated[-10:]), file = dsnapshopResults)
    print("list_T_r3_to_r1_updated[-10:] = {}".format(list_T_r3_to_r1_updated[-10:]))
    print("list_T_r3_to_r1_updated = {}".format(list_T_r3_to_r1_updated), file = detaileResults)
    print("list_T_r3_to_r1_updated[-10:] = {}".format(list_T_r3_to_r1_updated[-10:]), file = dsnapshopResults)
    print("list_T_r2_to_r3_updated[-10:] = {}".format(list_T_r2_to_r3_updated[-10:]))
    print("list_T_r2_to_r3_updated = {}".format(list_T_r2_to_r3_updated), file = detaileResults)
    print("list_T_r2_to_r3_updated[-10:] = {}".format(list_T_r2_to_r3_updated[-10:]), file = dsnapshopResults)
    print("list_T_r3_to_r2_updated[-10:] = {}".format(list_T_r3_to_r2_updated[-10:]))
    print("list_T_r3_to_r2_updated = {}".format(list_T_r3_to_r2_updated), file = detaileResults)
    print("list_T_r3_to_r2_updated[-10:] = {}".format(list_T_r3_to_r2_updated[-10:]), file = dsnapshopResults)
    # #
    detaileResults.close()
    dsnapshopResults.close()
# #
zz = 5 + 6
